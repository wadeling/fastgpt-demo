...
# 定义CSV文件路径
test_csv_file_path = 'plugin_aws_failed.csv'
...
def process_row(row, auth_token):
    ...
    prompt = sanitize_input(
        ...
        f"最匹配哪个CIS aws benchmark v3的recomandation. 要求recomandation所属的云产品必须是{scan_type}，没有匹配的返回'无对应云服务产品'."
    )
